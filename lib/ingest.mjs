...
export async function runIngest(ctx, deps = {}) {
  ...
  // Network resolution turns every needs-canonical lead into either a canonical ATS
  // posting URL (Tier 1 board probe, then the optional Tier 2 Tavily search) or a
  // live {company, title} search-URL fallback, so no dead tracking link ever reaches
  // buildJobs (#8). Already-canonical leads pass through untouched.
